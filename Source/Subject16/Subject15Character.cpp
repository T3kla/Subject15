...
void ASubject15Character::SetGunDynMaterialCpp(FColor& CurrentColorPower) //TODO (Calde): Coger puntero/Ref al GunDynMatCpp en PowerBase y cambiarle el color desde alli
{
	if (GunDynMaterialCpp)
...
void ASubject15Character::ChangePower(EPowers NewPower, int IntPowerChoose) //MAYBE: Bind event a Inputs WeaponToSlot1 y pasarle los parametros (Ahorra metodos intermedios)
{
